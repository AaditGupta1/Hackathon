...
btn_home = Button(main,text='HOME',bg=color_bg,font=(font,15),fg='#444444',border=0,command=home_page)
btn_about = Button(main,text='ABOUT',bg=color_bg,font=(font,15),fg='#444444',border=0,command=about_page)
...
btn_home.place(relx=0.5,rely=0.06,anchor=CENTER)
btn_about.place(relx=0.6,rely=0.06,anchor=CENTER)
btn_fitness.place(relx=0.7,rely=0.06,anchor=CENTER)
btn_contact.place(relx=0.8,rely=0.06,anchor=CENTER)
